...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/announcementtypes/autocomplete`, {
    params,
  });
  return response.data;
}

const AnnouncementtypesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.announcementtypes.hasPermissionToCreate,
});

export default connect(select)(AnnouncementtypesSelectItem);

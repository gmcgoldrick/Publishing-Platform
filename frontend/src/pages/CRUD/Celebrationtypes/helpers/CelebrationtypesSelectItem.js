...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/celebrationtypes/autocomplete`, {
    params,
  });
  return response.data;
}

const CelebrationtypesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.celebrationtypes.hasPermissionToCreate,
});

export default connect(select)(CelebrationtypesSelectItem);
